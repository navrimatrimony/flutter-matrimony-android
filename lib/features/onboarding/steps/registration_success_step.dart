...
class _RegistrationSuccessStepState extends State<RegistrationSuccessStep> {
  ...
  bool get _hasEmail =>
      onboardingBool(widget.account['email_present']) == true ||
      onboardingText(widget.account['email']) != null ||
      _verifiedInThisStep;
  ...
  bool get _needsEmail => !_hasEmail && _hasMobile;
  ...
  Widget _emailRequestCard(BuildContext context) {
    ...
    return _ActionPanel(
      ...
      title: _t('Add verified email', 'Verified email जोडा'),
      body: _t(
        'Continue with Google. If Google verification is not available, we will send an OTP to that email.',
        'Google ने पुढे जा. Google verification उपलब्ध नसेल तर त्याच email वर OTP पाठवू.',
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          ...
          else if (challengeId != null && email != null)
            _OtpBox(
              email: email,
              ...
              onVerify: _verifyOtp,
              onResend: _busy ? null : () => _sendOtp(email),
            )
          else
            _GooglePrompt(locale: widget.locale),
          if (_localInfo != null) ...[
            ...
            ElevatedButton.icon(
              ...
              label: Text(
                _workingGoogle
                    ...
                    : _t('Continue with Google', 'Google ने पुढे जा'),
              ),
            ),
          TextButton.icon(
            ...
            label: Text(
              _t("I don't have an Email ID", 'माझ्याकडे Email ID नाही'),
            ),
          ),
        ],
      ),
...
class _GooglePrompt extends StatelessWidget {
  const _GooglePrompt({required this.locale});
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                _t(
                  'Google will share your verified email. No typing needed.',
                  'Google तुमचा verified email देईल. Email type करावा लागणार नाही.',
                ),
                style: TextStyle(
